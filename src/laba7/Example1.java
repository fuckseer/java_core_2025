...
// Создание байла внутри папки
        File file = new File(folder.getAbsolutePath() + File.separator + "example_file.txt");
        try {
            if (file.createNewFile()) {
                System.out.println("Файл создан: " + file.getAbsolutePath());
            } else {
                System.out.println("He удалось создать файл: " + file.getAbsolutePath());
            }
        } catch (IOException e) {
            System.out.println("Ошибка при создании файла: " + e.getMessage());
        }
// Удаление байла и папки
        if (file.delete()) {
        ...
        if (folder.delete()) {
            ...
            System.out.println("He удалось удалить папку: " + folder.getAbsolutePath());
        }
    }
}
